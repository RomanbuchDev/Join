...
function inputPasswordCheck() {
    const inputPasswordCheck = document.getElementById("registerPassword");
    const icon = document.getElementById("visibility-icon-password");
...
function visibilityIconSwish(icon, inputPasswordCheck) {
    ...
    if (iconSrc === iconVisibilityOn) {
        inputPasswordCheck.type = "password";
        document.getElementById("visibility-icon-password").src = iconVisibilityOff;
    }
    if (iconSrc === iconVisibilityOff) {
        inputPasswordCheck.type = "text";
        document.getElementById("visibility-icon-password").src = iconVisibilityOn;
    }
    return;
}
...
function isSignupInputValid(signupUserData) {
    ...
    const confirmPasswordEmpty = checkConfirmPasswordField(signupUserData.password, signupUserData.confirmPassword);
    const message = getSignupErrorMessage(nameCheck, emailCheck, passwordEmpty, confirmPasswordEmpty);
 ...
 */
function getSignupErrorMessage(emailCheck, passwordEmpty) {
...
function getSignupFormValues() {
    ...
    const inputConfirmPassword = document.getElementById("registerConfirmPassword").value;
